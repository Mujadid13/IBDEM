    ...
    <section className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
      <div className="flex-1 space-y-6">
        <h1 className="text-4xl md:text-6xl font-bold">
          Transforming Health with Real-Time Environmental Data   
        </h1>
        <p className="text-lg text-muted-foreground">
          We leverage cutting-edge technology to combine real-time environmental data with health insights, empowering you to make informed decisions for a healthier future.
        </p>
